...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            image0 = Content.Load<Texture2D>(@"ProgrammingAssignment2Content\shiki1");
            image1 = Content.Load<Texture2D>(@"ProgrammingAssignment2Content\shiki2");
            image2 = Content.Load<Texture2D>(@"ProgrammingAssignment2Content\shiki3");

            // STUDENTS: set the currentSprite variable to one of your sprite variables
            currentSprite = image0;
        }
